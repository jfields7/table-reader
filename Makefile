...
.PHONY: install
install:
	mkdir -p $(INSTALL_DIR)/include/TableReader
	mkdir -p $(INSTALL_DIR)/lib
	cp $(HEADER_FILES) $(INSTALL_DIR)/include/TableReader
	cp $(LIBRARY) $(INSTALL_DIR)/lib

.PHONY: uninstall
uninstall:
	rm -rf $(INSTALL_DIR)/include/TableReader
